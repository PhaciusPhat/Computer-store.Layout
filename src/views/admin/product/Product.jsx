...
import { delete__product__action, get__products__action, save__product__action } from './../../../redux/action/product__action';
    ...
    const renderProducts = () => {
        return products?.content?.map((product, index) => {
            return <tr key={index}>
                ...
                <td><img src={product.urlMainImage} width={50} /></td>
